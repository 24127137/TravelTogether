...
class ApiConfig {
  ...
  static const String baseUrl = 'http://192.168.1.2:8000'; // emulator local
  ...
  static const String chatWebSocket = 'ws://192.168.1.2:8000/chat/ws'; // emulator local
  ...
  // Feedback endpoints
  static const String feedbackBaseUrl = "http://192.168.1.2:8000/feedbacks";
