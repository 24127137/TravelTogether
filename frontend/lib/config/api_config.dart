...
class ApiConfig {
  ...
  static const String baseUrl = 'http://10.177.82.17:8000'; // emulator local
  ...
  static const String chatWebSocket = 'ws://10.177.82.17:8000/chat/ws'; // emulator local
  ...
  static String chatWebSocketByGroup(String groupId) => 'ws://10.177.82.17:8000/chat/$groupId';
