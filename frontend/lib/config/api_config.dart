...
class ApiConfig {
  ...
  static const String baseUrl = 'http://10.229.137.17:8000'; // emulator local
  ...
  static const String chatWebSocket = 'ws://10.229.137.17:8000/chat/ws'; // emulator local
  ...
  static String chatWebSocketByGroup(String groupId) => 'ws://10.229.137.17:8000/chat/$groupId';
