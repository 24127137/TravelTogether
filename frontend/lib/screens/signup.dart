...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _submitSignup() async {
    final url = Uri.parse('http://10.0.2.2:8000/create-profile/'); //emulator
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // khi nao merge thi goi homepage o day
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget _buildTextField({
    ...
    return TextField(
      ...
      onChanged: (value) {
        if (obscure) {
          setState(() => _passwordStrength = _calculatePasswordStrength(value));
        } else {
          setState(() {});
        }
      },
