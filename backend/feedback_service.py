...
predefined_tags = [
    # 1 Star
    'bad', 'unreliable', 'irresponsible', 'broken_promises', 'disorganized',
    # 2 Stars
    'poor', 'late', 'unenthusiastic', 'uncooperative', 'needs_improvement',
    # 3 Stars
    'average', 'punctual', 'participative', 'cooperative', 'decent',
    # 4 Stars
    'good', 'enthusiastic', 'friendly', 'helpful', 'trustworthy',
    # 5 Stars
    'excellent', 'amazing', 'professional', 'fun', 'creative'
]
